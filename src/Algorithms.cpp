...
bool Algorithms::parse_srcnn(std::string str, std::array<unsigned char, 3>* kernels_out,
	...
	try {
		...
		std::array<unsigned char, 3> kernels = {0, 0, 0};
		std::array<unsigned char, 3> paddings = {0, 0, 0};
		std::array<unsigned char, 2> channels = {0, 0};
...
bool Algorithms::parse_fsrcnn(std::string str, std::array<unsigned char, 4>* kernels_out,
	...
	try {
		...
		std::array<unsigned char, 4> kernels = {0, 0, 0, 0};
		std::array<unsigned char, 4> paddings = {0, 0, 0, 0};
		std::array<unsigned char, 3> channels = {0, 0, 0};
